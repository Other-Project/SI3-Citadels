...
public class Main {
    ...
    public static void main(String... args) throws Exception {
        ...
        if (main.twoThousand) {
            results = playMultipleGames(1000, 6, new Bot("Bot"), new DiscreetBot("Discrete Bot"), new FearFulBot("Fearful Bot"), new AgressiveBot("Aggressive Bot"), new RandomBot("Random Bot"), new RichardBot("Richard Bot"));
